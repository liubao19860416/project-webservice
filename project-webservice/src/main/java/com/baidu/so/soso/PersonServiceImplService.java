 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.itcast.cn/", wsdlLocation = "http://192.168.1.100:9527/personService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.itcast.cn/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.100:9526/personService?wsdl");
    ...
    public PersonServiceImpl getPersonServiceImplPort() {
        return super.getPort(new QName("http://service.itcast.cn/", "PersonServiceImplPort"), PersonServiceImpl.class);
    }
    ...
    public PersonServiceImpl getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.itcast.cn/", "PersonServiceImplPort"), PersonServiceImpl.class, features);
    }
