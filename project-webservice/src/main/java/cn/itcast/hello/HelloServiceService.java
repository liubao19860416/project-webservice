 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://hello.itcast.cn/", wsdlLocation = "http://192.168.1.100:8090/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://hello.itcast.cn/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.100:8090/helloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://hello.itcast.cn/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.itcast.cn/", "HelloServicePort"), HelloService.class, features);
    }
